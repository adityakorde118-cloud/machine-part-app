...
function About() {
  return (
    <div>
       <div className="text-black px-2 md:p-0">
    
      <section className="relative bg-black text-white py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h1 className=" text-xl  md:text-3xl font-bold  heding">
            About MechaParts Industries
          </h1>
          <p className="text-sm md:text-lg discription  leading-relaxed max-w-3xl mx-auto text-gray-300">
      ...
      <section className="py-16  app-Shadow">
        <div className="max-w-6xl  text-center  app-Shadow bg-white p-4 rounded-2xl border-2 border-[#e9e9e993] mx-auto px-6 grid md:grid-cols-2 gap-6 items-center">
          ...
          <div>
            <h2 className=" text-xl md:text-3xl heding font-bold mb-4 text-gray-900">
              Precision in Every Component
            </h2>
            <p className=" text-[14px]  md:text-sm  leading-relaxed  discription text-gray-600">
            ...
            <p className="text-[14px]  md:text-sm leading-relaxed discription text-gray-600 mt-4">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl app-Shadow bg-white p-4 rounded-2xl border-2 border-[#e9e9e993] mx-auto px-6 grid md:grid-cols-2 gap-6 items-center">
          <div>
            <h2 className="text-xl  md:text-3xl heding text-center font-bold mb-4 text-gray-900">
              Driven by Technology and Innovation
            </h2>
            <p className="text-[14px]  md:text-sm text-center leading-relaxed discription text-gray-600">
            ...
            <p className="text-[14px]  md:text-sm  text-center leading-relaxed discription text-gray-600 mt-4">
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-gray-700 text-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className=" text-2xl md:text-3xl font-bold mb-10 heding">Our Core Values</h2>
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              >
                <h3 className=" text-lg md:text-xl font-semibold mb-3 heding">{item.title}</h3>
                <p className="text-[14px] md:text-sm text-gray-300 leading-relaxed discription">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className= " text-xl  md:text-3xl heding font-bold mb-6 text-gray-900">
            Building the Future with Precision
          </h2>
          <p className=" text-[14px] md:text-sm leading-relaxed discription text-gray-600 max-w-3xl mx-auto">
          ...
          <p className="text-[14px] md:text-sm leading-relaxed discription text-gray-600 mt-6 max-w-3xl mx-auto">
